...
requiredData = data(data(:,7) == 3 & data(:,8) >=7 & data(:,8) <= 21,2:6); %2:5

%padaryti su 16 inputu
input1 = requiredData(1:1:end-6,1);
input2 = requiredData(1:1:end-6,2);
input3 = requiredData(1:1:end-6,3);
input4 = requiredData(1:1:end-6,4);
input4h = requiredData(1:1:end-6,5);

input5 = requiredData(2:1:end-5,1);
input6 = requiredData(2:1:end-5,2);
input7 = requiredData(2:1:end-5,3);
input8 = requiredData(2:1:end-5,4);
input8h = requiredData(2:1:end-5,5);

input9 = requiredData(3:1:end-4,1);
input10 = requiredData(3:1:end-4,2);
input11 = requiredData(3:1:end-4,3);
input12 = requiredData(3:1:end-4,4);
input12h = requiredData(3:1:end-4,5);

input13 = requiredData(4:1:end-3,1);
input14 = requiredData(4:1:end-3,2);
input15 = requiredData(4:1:end-3,3);
input16 = requiredData(4:1:end-3,4);
input16h = requiredData(4:1:end-3,5);

output = requiredData(7:1:end,1);
...
inputs = [inputs input4h input8h input12h input16h];
...
%train_inputs = mapminmax('reverse', train_inputs(:,end-4)', settings1)';
