...
output1 = requiredData(5:5:end,1);
output2 = requiredData(5:5:end,2);
output3 = requiredData(5:5:end,3);
output4 = requiredData(5:5:end,4);

preparedData = [input1 input2 input3 input4 input5 input6 input7 input8 input9 input10 input11 input12 input13 input14 input15 input16 output1 output2 output3 output4];
...
tmin = min(abs(trainOutput(:,1) - train_targets(:,1)));
tmax = max(abs(trainOutput(:,1) - train_targets(:,1)));
tmae = mean(abs(trainOutput(:,1) - train_targets(:,1)));
tmse = mean((trainOutput(:,1) - train_targets(:,1)).^2);
tstd = std(abs(trainOutput(:,1) - train_targets(:,1)));
...
pmse = mean((predicted_targets(:,1) - test_targets(:,1)).^2);
pstd = std(allErrors2);
